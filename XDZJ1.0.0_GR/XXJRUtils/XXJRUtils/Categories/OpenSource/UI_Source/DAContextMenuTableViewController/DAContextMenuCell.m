...
-(void)setActualContentView:(UIView *)actualContentView{
    self.actualContentView = actualContentView;
}

-(UIView *)actuaLContentView{
    if (_actuaLContentView == nil) {
        _actuaLContentView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 320, 58)];
        _actuaLContentView.backgroundColor = [UIColor whiteColor];
