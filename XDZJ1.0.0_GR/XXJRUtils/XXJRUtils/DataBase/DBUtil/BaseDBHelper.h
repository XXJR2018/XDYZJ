...
/*!
 @brief     根据对应的Sql语句，查询出对应字段集合
 */
- (NSArray *)executeSql:(NSString *) sqlStament
               withArguments:(NSArray *) arguments
               andColumnName:(NSArray *) columnNames;

/*!
 @brief     根据对应的Sql语句，查询出对应字段
 */
- (NSInteger) executeSql_errorTitleCount:(NSString *) sqlStament
                           withArguments:(NSArray *) arguments;
@end
