...
+ (UIImage *)logo{
    return [UIImage imageNamed:@"xxjr_logo"];
}
...
+ (UIImage *)arrow_return{
    return [UIImage imageNamed:@"return_white"];
}
...
+ (UIImage *)tabBar_button1_gray{
    return [PDAPI isTestUser]?[UIImage imageNamed:@"TabbarMJ1"]:[UIImage imageNamed:@"Tabbar_1"];
}

+ (UIImage *)tabBar_button1_selected{
    return [PDAPI isTestUser]?[UIImage imageNamed:@"TabbarMJ1_H"]:[UIImage imageNamed:@"Tabbar_1_Highlight"];
}

+ (UIImage *)tabBar_button2_gray{
    return [PDAPI isTestUser]?[UIImage imageNamed:@"TabbarMJ2"]:[UIImage imageNamed:@"Tabbar_2"];
}

+ (UIImage *)tabBar_button2_selected{
   return [PDAPI isTestUser]?[UIImage imageNamed:@"TabbarMJ2_H"]:[UIImage imageNamed:@"Tabbar_2_Highlight"];
}

+ (UIImage *)tabBar_button3_gray{
    return [PDAPI isTestUser]?[UIImage imageNamed:@"TabbarMJ3"]:[UIImage imageNamed:@"Tabbar_3"];
}

+ (UIImage *)tabBar_button3_selected{
    return [PDAPI isTestUser]?[UIImage imageNamed:@"TabbarMJ3_H"]:[UIImage imageNamed:@"Tabbar_3_Highlight"];
}
...
+ (UIImage *)shareIcon{
    return [UIImage imageNamed:@"shareIcon"];
}

+ (UIImage *)tips{
    return [UIImage imageNamed:@"tips"];
}


/********************************下划线*******************************/
+ (UIImage *)line_dotLine{
    return [UIImage imageNamed:@"line_dotLine"];
}
