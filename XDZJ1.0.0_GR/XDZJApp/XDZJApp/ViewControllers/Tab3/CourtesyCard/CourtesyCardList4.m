...
//  XXJR
//
//  Created by xxjr02 on 2017/10/31.
...
@interface CourtesyCardList4 ()

@end

@implementation CourtesyCardList4
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        UIImageView *imgGQ = [[UIImageView alloc] initWithFrame:CGRectMake(fCellWidth - 90, 20, 70, 25)];
        [viewCell addSubview:imgGQ];
        imgGQ.image = [UIImage imageNamed:@"card_overdue"];
