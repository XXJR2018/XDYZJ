...
-(CustomNavigationBarView *)layoutNaviBarViewWithTitle:(NSString *)title{
    ...
    if (!self.hideBackButton) {
        ...
        [buttonLeft setImage:[UIImage imageNamed:@"return"] forState:UIControlStateNormal];
        ...
        navBarView = [[CustomNavigationBarView alloc] initWithTitle:title withLeftButton:buttonLeft withRightButton:nil withBackColorStyle:NavigationBarViewBackColorBlack];
        [self.view addSubview:navBarView];
    }else{
        navBarView = [[CustomNavigationBarView alloc] initWithTitle:title withLeftButton:nil withRightButton:nil withBackColorStyle:NavigationBarViewBackColorBlack];
        [self.view addSubview:navBarView];
    }
    return navBarView;
//    // 设置状态栏字体颜色为白色
...
//        buttonLeft.tag = 10011;
//        [buttonLeft addTarget:self action:@selector(clickNavButton:) forControlEvents:UIControlEventTouchUpInside];
//        navBarView = [[CustomNavigationBarView alloc] initWithTitle:title withLeftButton:buttonLeft withRightButton:nil withBackColorStyle:NavigationBarViewBackColorWhite];
//        [self.view addSubview:navBarView];
//    }else{
//        navBarView = [[CustomNavigationBarView alloc] initWithTitle:title withLeftButton:nil withRightButton:nil withBackColorStyle:NavigationBarViewBackColorWhite];
//        [self.view addSubview:navBarView];
//    }
//    return navBarView;
}
...
-(CustomNavigationBarView *)layoutWhiteNaviBarViewWithTitle:(NSString *)title{
