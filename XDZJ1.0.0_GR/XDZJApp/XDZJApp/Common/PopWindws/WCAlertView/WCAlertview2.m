...
-(void)setUp{
    ...
    self.alertview = [[UIView alloc] initWithFrame:CGRectMake(0, 0, alertviewWidth, 380+100)];
    ...
    label1.text = @"    平台所有客户都是自己申请的，必须通过手机验证才可以提交贷款申请，原则上一经抢单将不能退款，出现以下的情况，小小金融在经过人工核实之后可以酌情退款。";
    ...
    label3_1.text = @"● 价格低于10元的单子将不能申请退款；\n\n● 申请退单必须在抢完单后3个工作日内提交，超过时限不予处理,会员特价单不能申请退款;\n\n● 小小金融将在用户申请退款之后3日内进行处理。";
...
-(void)setUp2{
    ...
    _titleCKXQ = [[UILabel alloc] initWithFrame:CGRectMake(40,iTopY,alertviewWidth-80,20)];
    ...
    _titleCKXQ.font = [UIFont systemFontOfSize:18];
    _titleCKXQ.textColor = [ResourceManager mainColor];
