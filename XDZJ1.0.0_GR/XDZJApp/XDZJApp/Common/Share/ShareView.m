...
-(id)initWithType:(NSArray *)types index:(int)index block:(Block_Tap)block{
    if (self = [super initWithFrame:CGRectMake((ShareView_Size - (index == 0 ? 0 : 10)) * index, 0.f, ShareView_Size - 10.f, ShareView_Size)]) {
...
- (instancetype)initWithTypes:(NSArray *)types frame:(CGRect)rect
{
    ...
    if (self) {
        ...
        button.frame = CGRectMake(0, _viewHeight - 36.0, _shareView.width, 36.0);
