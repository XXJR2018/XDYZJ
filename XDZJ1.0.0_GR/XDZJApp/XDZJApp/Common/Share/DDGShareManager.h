...
//typedef NS_ENUM(NSUInteger, DDGShareTypes)
//{
//    DDGShareTypesAll,              //default
//    DDGShareTypeWeChat_haoyou,
//    DDGShareTypeWeChat_pengyouquan,
//    DDGShareTypeSinaWeibo,
//    DDGShareTypeQQ
//};
...
extern NSString *const DDGShareTypeSinaWeibo            ;
...
//// Sina
//-(void)sinaShareSuccess:(NSMutableDictionary *)result;
//
//-(void)sinaShareFailed:(NSMutableDictionary *)result;
//
//// QQ
//-(void)QQShareSuccess:(NSMutableDictionary *)result;
//
//-(void)QQShareFailed:(NSMutableDictionary *)result;
//
//// WeChat
//-(void)weChatShareSuccess:(NSMutableDictionary *)result;
//
//-(void)weChatShareFailed:(NSMutableDictionary *)result;
 ...
 *
 *  @param items 分享的内容
 *  @param types @[DDGShareTypeWeChat_haoyou,DDGShareTypeSinaWeibo]
 *
 */
